...
def setrun(claw_pkg='geoclaw'):
    ...
    # list of possible (non-ASCE) gauges:
    gauges_csv_file = root_dir +'/gis/2011/Formatted/ObservationLocationInfo.csv'
    print(gauges_csv_file)
    gaugenos = [205, 801, 802, 803, 804, 806, 10001, 10002, 10003, 10004, 10005] #
    if making_DART:
        gaugenos = [21401, 21413, 21418, 21419] + gaugenos
    ...
    # Time interval :  (0,1e9)
    regions.append([5, 5, 0., 1e9, 140.84, 141.10, 37.75, 38.34])
