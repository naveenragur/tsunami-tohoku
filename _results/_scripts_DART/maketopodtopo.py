...
def make_dtopo(EveMw, EveLat, EveLon, EveDep, makeplots=False):
    ...
    asc_fname = os.path.join(ASCDir, 'tohoku_dtopo_' + str(EveMw) + "_" + str(EveLat) + "_" + str(EveLon) + '.asc')
    prj_fname = os.path.join(ASCDir, 'tohoku_dtopo_' + str(EveMw) + "_" + str(EveLat) + "_" + str(EveLon) + 'prj')
...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    fnames = glob.glob('/home/nrr/Tsunami/Tohoku/gis/2011/source/_input2script/*.csv*')
    fnames.remove('/home/nrr/Tsunami/Tohoku/gis/2011/source/_input2script/SATAKE2013.csv')
    fnames = ['/home/nrr/Tsunami/Tohoku/gis/2011/source/_input2script/FUJI2011_42.csv','/home/nrr/Tsunami/Tohoku/gis/2011/source/_input2script/FUJI2011_46.csv']
